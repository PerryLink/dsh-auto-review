...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `0.1.1-rc.2` (dependencies `0.1.1-rc.2` पर पिन की गईं; peers `>=0.1.0-rc.8 <0.2.0`) |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
- **सीड देने वाला प्रदाता छाना नहीं जाता।** डिफ़ॉल्ट `reviewerProvider: fork` समीक्षक को प्रत्यायोजक सत्र के पूर्ण हुए टर्न की प्रतिलिपि पर शुरू करता है, और उस प्रतिलिपि में वह सारा संदर्भ होता है जो पैरेंट को मिला था — वर्कस्पेस निर्देश फ़ाइलों सहित। `pre-step` फ़ायरवॉल उस इतिहास को नहीं हटा सकता जो पहले से चाइल्ड का सीड है; समीक्षक प्रॉम्प्ट अपने बाहर की हर चीज़ को अविश्वसनीय ट्रांसक्रिप्ट घोषित करता है — यह शमन है, पृथक्करण नहीं। बिना विरासत संदर्भ वाले समीक्षक के लिए `reviewerProvider: spawn` (शून्य पैरेंट संदर्भ) सेट करें और साक्ष्य `contextBudget` से दें।
