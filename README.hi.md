...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.5-alpha.1` (GitHub tag, 2026-09-09 को सत्यापित)। दोहरी-लाइन npm समर्थन: dev पिन `0.1.5-alpha.1`, रनटाइम निर्भरताएँ `0.1.2-rc.1`, peers `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0` — रनटाइम दोनों प्रकाशित होस्ट लाइनों को संभालता है (फ़ीचर-डिटेक्टेड), और हर लाइन पूरी गेट श्रृंखला चलाती है। |
| Node | `^22.19.0 \|\| >=24.0.0` |
