...
- **सत्र लॉग**: `autoReview/*` घटनाएँ समीक्षक पहचान, निर्णय, कारण, जोखिम और अवधि रखती हैं — लिफ़ाफ़े के `ignorable: true` मार्कर के साथ जोड़ी जाती हैं ताकि कोई भी बिल्ड लॉग लोड कर सके।
...
- `autoReview/state` और `autoReview/verdict` लिफ़ाफ़े के `ignorable: true` मार्कर के साथ जोड़े जाते हैं, ताकि कोई भी harness बिल्ड लॉग लोड करे — जो पाठक रेपो-बाहरी प्रकारों को नहीं जानते वे उन रिकॉर्ड को बस छोड़ देते हैं। (rc.6 होस्ट मार्कर को स्वीकार कर उसे अनदेखा करते हैं; 0.1.1 से पहले के संस्करणों द्वारा लिखे गए सत्रों को `dsh-permission-rules` के `scripts/repair-session-logs.mjs` से मरम्मत किया जा सकता है।)
