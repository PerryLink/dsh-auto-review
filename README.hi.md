...
डिफ़ॉल्ट पैच में `bash`, `write` और `edit` AI समीक्षा से गुज़रते हैं; बाकी टूल मानव शृंखला को सौंपे जाते हैं।
...
| `riskRules` | `[]` | `{pattern, policy}` — अनुरोध के कारण पर मिलान (पहला मिलान जीतता है), टूल-तालिका से **पहले** |
