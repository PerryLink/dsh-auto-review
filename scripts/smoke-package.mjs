...
// @deepseek-ai/dsh-invariants at a prerelease range, and pnpm merges those
// into a stable-anchored spec that no published prerelease satisfies
// (ERR_PNPM_NO_MATCHING_VERSION). Pin these packages at the line this repo
