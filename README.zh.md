...
| 方面 | 状态 |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.5-alpha.1`（GitHub tag，2026-09-09 已核验）。双线 npm 支持：dev 钉号 `0.1.5-alpha.1`、运行时依赖 `0.1.2-rc.1`、peer 范围 `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0` —— 运行时兼容两条已发布宿主线（特性探测），两线均跑完整门禁链。 |
| Node | `^22.19.0 \|\| >=24.0.0` |
