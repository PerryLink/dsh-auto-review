...
| Superficie | Estado |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.3-alpha.1` (tag de GitHub, verificado el 2026-09-06). Soporte npm de doble línea (migrado el 2026-09-08): pins de desarrollo `0.1.3-alpha.2`, dependencias de runtime `0.1.2-rc.1`, peers `>=0.1.2-rc.1 <0.2.0` — el runtime maneja ambas líneas de host publicadas (detección de características), y cada línea ejecuta la cadena completa de gates. |
| Node | `^22.19.0 \|\| >=24.0.0` |
